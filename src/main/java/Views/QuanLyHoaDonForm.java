...
public class QuanLyHoaDonForm extends javax.swing.JFrame {
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        ...
        if (maHoaDon.isEmpty() || ngayLap.isEmpty() || maKhachHang.isEmpty() || maXe.isEmpty() || soLuongStr.isEmpty() || donGiaStr.isEmpty() || pttt.isEmpty() || maNV.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Bạn phải điền đầy đủ thông tin", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            if (soLuong < 0 || donGia < 0) {
                JOptionPane.showMessageDialog(rootPane, "Số lượng và đơn giá phải là số nguyên không nhỏ hơn 0", "Thông báo", JOptionPane.WARNING_MESSAGE);
                return;
            }
        } catch (NumberFormatException e) {
            JOptionPane.showMessageDialog(rootPane, "Số lượng và đơn giá phải là số nguyên", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(rootPane, "Ngày nhập phải đúng định dạng dd/MM/yyyy", "Thông báo", JOptionPane.WARNING_MESSAGE);
            return;
        }
    ...
    private void btn_themActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_themActionPerformed
        try {
            ...
            // Kiểm tra các trường không được bỏ trống
            if (maHoaDon.isEmpty() || ngayLap.isEmpty() || maKhachHang.isEmpty() || maXe.isEmpty() || soLuongStr.isEmpty() || donGiaStr.isEmpty() || maNV.isEmpty() || pttt.isEmpty()) {
                JOptionPane.showMessageDialog(null, "Bạn phải điền đầy đủ thông tin", "Thông báo", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            try {
                ...
                donGia = Integer.parseInt(donGiaStr);
                if (soLuong < 0 || donGia < 0) {
                    JOptionPane.showMessageDialog(null, "Số lượng và đơn giá phải là số nguyên lớn hơn 0", "Thông báo", JOptionPane.WARNING_MESSAGE);
                    return;
                }
            } catch (NumberFormatException e) {
                JOptionPane.showMessageDialog(null, "Số lượng và đơn giá phải là số nguyên", "Thông báo", JOptionPane.WARNING_MESSAGE);
                return;
            }
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "Ngày nhập phải đúng định dạng dd/MM/yyyy", "Thông báo", JOptionPane.WARNING_MESSAGE);
                return;
            }
